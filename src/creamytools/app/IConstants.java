...
public interface IConstants {
    ...
    /**
     * プログラムの終了コード（ebean.propertiesファイル関連エラー）
     */
    public static final int ENDCODE_ERROR_EBEANPROP         = 7;
    
    /**
     * プログラムの終了コード（jar コマンド実行エラー）
     */
    public static final int ENDCODE_ERROR_EXECJAR           = 8;
    
    /**
     * プログラムの終了コード（エントリーポイントファイル上書きエラー）
     */
    public static final int ENDCODE_ERROR_EPTOWR            = 9;
